...
def hard():
    ...
    frame1.pack(anchor="n", ipadx=450, pady=10)
    ...
    def onclik(i,j,plateau_de_bombe, plateau_win):
        ...
        if plateau_de_bombe[i][j]==9:
            ...
            display_score = tk.Label(windows_hard, text="Ton Score :", bg="#B1A8A8", fg="blue", font=("Retro Gaming", 30))
            display_score.place(x=570, y=650)
            display_score_number = tk.Label(windows_hard, textvariable=appel_score, bg="#B1A8A8", fg="blue", font=("Retro Gaming", 30))
